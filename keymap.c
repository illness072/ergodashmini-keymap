...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_ESC,  XXXXXXX, KC_LALT,          LOWER,   KC_LCMD, KC_LSFT, KC_SPC,        KC_SPC, KC_ENT,  KC_BSPC, RAISE,            XXXXXXX, KC_MINS, KC_EQL   \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_ESC,  XXXXXXX, KC_LALT,          LOWER,   KC_LCMD, KC_LSFT, KC_SPC,        KC_SPC, KC_ENT,  KC_DEL,  RAISE,            XXXXXXX, KC_UNDS, KC_PLUS  \
  ),
